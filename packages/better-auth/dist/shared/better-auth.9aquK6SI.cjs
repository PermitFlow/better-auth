...
const schema$1 = require('./better-auth.BwjvqGUo.cjs');
...
const admin = (options) => {
  ...
  const adminMiddleware = socialProviders_index.createAuthMiddleware(async (ctx) => {
  ...
  return {
    ...
    endpoints: {
      setRole: socialProviders_index.createAuthEndpoint(
        "/admin/set-role",
        {
          method: "POST",
          body: zod.z.object({
      ...
      createUser: socialProviders_index.createAuthEndpoint(
        "/admin/create-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      listUsers: socialProviders_index.createAuthEndpoint(
        "/admin/list-users",
        {
          method: "GET",
          use: [adminMiddleware],
      ...
      listUserSessions: socialProviders_index.createAuthEndpoint(
      ...
      unbanUser: socialProviders_index.createAuthEndpoint(
        "/admin/unban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      banUser: socialProviders_index.createAuthEndpoint(
        "/admin/ban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      impersonateUser: socialProviders_index.createAuthEndpoint(
      ...
      stopImpersonating: socialProviders_index.createAuthEndpoint(
      ...
      revokeUserSession: socialProviders_index.createAuthEndpoint(
      ...
      revokeUserSessions: socialProviders_index.createAuthEndpoint(
      ...
      removeUser: socialProviders_index.createAuthEndpoint(
        "/admin/remove-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      setUserPassword: socialProviders_index.createAuthEndpoint(
      ...
      userHasPermission: socialProviders_index.createAuthEndpoint(
