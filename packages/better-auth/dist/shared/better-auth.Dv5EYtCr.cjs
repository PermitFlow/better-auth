...
const schema = require('./better-auth.BwjvqGUo.cjs');
...
const kyselyAdapter = require('./better-auth._dAJf_oa.cjs');
const memoryAdapter = require('./better-auth.CkL-IpXS.cjs');
require('kysely');
