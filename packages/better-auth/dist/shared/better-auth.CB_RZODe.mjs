...
import { z } from 'zod';
import { f as createAuthMiddleware, s as sessionMiddleware, i as createAuthEndpoint, j as getSessionFromCtx, B as BASE_ERROR_CODES, a0 as requestOnlySessionMiddleware } from './better-auth.BOAoJXX4.mjs';
...
const listUserInvitations = createAuthEndpoint(
