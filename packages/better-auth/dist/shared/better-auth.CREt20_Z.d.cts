import { L as LiteralString, d as LiteralUnion, D as DeepPartial, U as UnionToIntersection, S as StripEmptyObjects, a as Prettify, O as OmitId, P as PrettifyDeep, E as Expand } from './better-auth.9XhOL8gb.cjs';
import * as zod from 'zod';
import { ZodSchema, z } from 'zod';
import { a as OAuthProvider, S as SocialProviders, b as SocialProviderList, O as OAuth2Tokens } from './better-auth.48LtINOO.cjs';
...
type CleanedWhere = Prettify<Required<Omit<Where, "mode">>> & Pick<Where, "mode">;
...
declare const signInSocial: {
    <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(inputCtx_0: {
        body: {
            provider: "apple" | (string & {}) | "discord" | "facebook" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion";
    ...
    options: {
        ...
        body: z.ZodObject<{
             ...
             */
            provider: z.ZodType<"apple" | (string & {}) | "discord" | "facebook" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion", z.ZodTypeDef, "apple" | (string & {}) | "discord" | "facebook" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion">;
            /**
...
declare function getEndpoints<C extends AuthContext, Option extends BetterAuthOptions>(ctx: Promise<C> | C, options: Option): {
    api: {
        ...
        signInSocial: {
            <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(inputCtx_0: {
                body: {
                    provider: (string & {}) | "github" | "apple" | "discord" | "facebook" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion";
                    callbackURL?: string | undefined;
                    newUserCallbackURL?: string | undefined;
                    errorCallbackURL?: string | undefined;
                    disableRedirect?: boolean | undefined;
            ...
            options: {
                ...
                body: zod.ZodObject<{
                    ...
                    provider: zod.ZodType<(string & {}) | "github" | "apple" | "discord" | "facebook" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion", zod.ZodTypeDef, (string & {}) | "github" | "apple" | "discord" | "facebook" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion">;
        ...
        signInSocial: {
            ...
            options: {
                ...
                body: zod.ZodObject<{
                    ...
                    newUserCallbackURL: zod.ZodOptional<zod.ZodString>;
                    errorCallbackURL: zod.ZodOptional<zod.ZodString>;
                    provider: zod.ZodType<"apple" | (string & {}) | "discord" | "facebook" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion", zod.ZodTypeDef, "apple" | (string & {}) | "discord" | "facebook" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "zoom" | "notion">;
                    disableRedirect: zod.ZodOptional<zod.ZodBoolean>;
                    idToken: zod.ZodOptional<zod.ZodObject<{
                        token: zod.ZodString;
                        nonce: zod.ZodOptional<zod.ZodString>;
...
export { shouldPublishLog as $, setCookieToHeader as D, betterAuth as E, init as N, levels as _, createEmailVerificationToken as a$, createLogger as a2, logger as a3, createInternalAdapter as a6, createFieldAttribute as a9, setSessionCookie as aA, deleteSessionCookie as aB, parseCookies as aC, getSessionCookie as aE, getCookieCache as aF, parseSetCookieHeader as aG, getEndpoints as aH, router as aI, signInSocial as aJ, signInEmail as aK, callbackOAuth as aL, getSession as aM, getSessionFromCtx as aN, sessionMiddleware as aO, requestOnlySessionMiddleware as aP, freshSessionMiddleware as aQ, listSessions as aR, revokeSession as aS, revokeSessions as aT, revokeOtherSessions as aU, signOut as aV, requestPasswordReset as aW, forgetPassword as aX, requestPasswordResetCallback as aY, forgetPasswordCallback as aZ, resetPassword as a_, getAuthTables as ag, accountSchema as ah, userSchema as ai, sessionSchema as aj, verificationSchema as ak, parseOutputData as al, getAllFields as am, parseUserOutput as an, parseAccountOutput as ao, parseSessionOutput as ap, parseInputData as aq, parseUserInput as ar, parseAdditionalUserInput as as, parseAccountInput as at, parseSessionInput as au, mergeSchema as av, createCookieGetter as aw, getCookies as ax, setCookieCache as az, sendVerificationEmailFn as b0, sendVerificationEmail as b1, verifyEmail as b2, updateUser as b3, changePassword as b4, setPassword as b5, deleteUser as b6, deleteUserCallback as b7, changeEmail as b8, error as b9, ok as ba, signUpEmail as bb, listUserAccounts as bc, linkSocialAccount as bd, unlinkAccount as be, getAccessToken as bf, refreshToken as bg, accountInfo as bh, originCheckMiddleware as bi, originCheck as bj, BASE_ERROR_CODES as f, createAuthMiddleware as j, createAuthEndpoint as k, optionsMiddleware as o, checkPassword as s };
export type { AdapterDebugLogs as A, BetterAuthOptions as B, CreateCustomAdapter as C, FilterActions as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, AdditionalSessionFieldsInput as J, KyselyDatabaseType as K, Account as L, Models as M, Where as O, AdapterSchemaCreation as P, AdapterInstance as Q, RateLimit as R, Session as S, SecondaryStorage as T, User as U, Verification as V, WithJsDoc as W, FilteredAPI as X, InferSessionAPI as Y, LogLevel as Z, Adapter as a, Logger as a0, LogHandlerParams as a1, FieldAttribute as a4, FieldType as a5, InternalAdapter as a7, FieldAttributeConfig as a8, EligibleCookies as aD, InferValueType as aa, InferFieldsOutput as ab, InferFieldsInput as ac, InferFieldsInputClient as ad, PluginFieldAttribute as ae, BetterAuthDbSchema as af, BetterAuthCookies as ay, AdapterConfig as b, CustomAdapter as c, CleanedWhere as d, AdapterTestDebugLogs as e, AuthPluginSchema as g, BetterAuthPlugin as h, InferPluginErrorCodes as i, AuthEndpoint as l, AuthMiddleware as m, Auth as n, AuthContext as p, InferUser as q, InferSession as r, InferAPI as t, AdditionalSessionFieldsOutput as u, AdditionalUserFieldsOutput as v, InferFieldsFromPlugins as w, InferFieldsFromOptions as x, AdditionalUserFieldsInput as y, InferPluginTypes as z };
