...
const socialProviders_index = require('./better-auth.DKtenllA.cjs');
require('./better-auth.DiSjtgs9.cjs');
require('@better-auth/utils/base64');
require('@better-auth/utils/hmac');
require('@better-auth/utils/binary');
require('./better-auth.BwjvqGUo.cjs');
...
const orgMiddleware = socialProviders_index.createAuthMiddleware(async (ctx) => {
  return {};
});
...
const createInvitation = (option) => socialProviders_index.createAuthEndpoint(
...
const acceptInvitation = socialProviders_index.createAuthEndpoint(
...
const rejectInvitation = socialProviders_index.createAuthEndpoint(
...
const cancelInvitation = socialProviders_index.createAuthEndpoint(
...
const getInvitation = socialProviders_index.createAuthEndpoint(
...
const listInvitations = socialProviders_index.createAuthEndpoint(
...
const listUserInvitations = socialProviders_index.createAuthEndpoint(
...
const addMember = () => socialProviders_index.createAuthEndpoint(
...
const removeMember = socialProviders_index.createAuthEndpoint(
...
const getActiveMember = socialProviders_index.createAuthEndpoint(
...
const leaveOrganization = socialProviders_index.createAuthEndpoint(
  "/organization/leave",
  {
    method: "POST",
    body: zod.z.object({
    ...
    use: [socialProviders_index.sessionMiddleware, orgMiddleware]
  },
  async (ctx) => {
    const session = ctx.context.session;
...
const createOrganization = socialProviders_index.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
const checkOrganizationSlug = socialProviders_index.createAuthEndpoint(
  "/organization/check-slug",
  {
    ...
    use: [socialProviders_index.requestOnlySessionMiddleware, orgMiddleware]
  },
  async (ctx) => {
...
const updateOrganization = socialProviders_index.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
const deleteOrganization = socialProviders_index.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
const getFullOrganization = () => socialProviders_index.createAuthEndpoint(
...
const listOrganizations = socialProviders_index.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
zod.z.object({
  id: zod.z.string().default(logger.generateId),
  name: zod.z.string(),
  slug: zod.z.string(),
...
const createTeam = (options) => socialProviders_index.createAuthEndpoint(
...
const removeTeam = socialProviders_index.createAuthEndpoint(
...
const updateTeam = socialProviders_index.createAuthEndpoint(
...
const listOrganizationTeams = socialProviders_index.createAuthEndpoint(
