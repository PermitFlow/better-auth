  ...
  if (dbUser) {
    ...
    if (overrideUserInfo) {
      ...
      await c.context.internalAdapter.updateUser(dbUser.user.id, {
        ...
        emailVerified: userInfo.email.toLowerCase() === dbUser.user.email.toLowerCase() ? dbUser.user.emailVerified || userInfo.emailVerified : userInfo.emailVerified
      });
    }
  } else {
    if (disableSignUp) {
...
export { signInSocial as $, ok as A, BASE_ERROR_CODES as B, accountInfo as C, getAccessToken as D, refreshToken as E, unlinkAccount as F, deleteUserCallback as G, HIDE_METADATA as H, listUserAccounts as I, linkSocialAccount as J, revokeOtherSessions as K, revokeSessions as L, revokeSession as M, requestPasswordResetCallback as N, requestPasswordReset as O, forgetPasswordCallback as P, deleteUser as Q, setPassword as R, changePassword as S, changeEmail as T, sendVerificationEmail as U, verifyEmail as V, resetPassword as W, forgetPassword as X, signInEmail as Y, signOut as Z, callbackOAuth as _, validateToken as a, requestOnlySessionMiddleware as a0, socialProviderList as a1, SocialProviderListEnum as a2, apple as a3, getApplePublicKey as a4, discord as a5, dropbox as a6, facebook as a7, github as a8, linear as a9, linkedin as aa, gitlab as ab, google as ac, kick as ad, microsoft as ae, notion as af, reddit as ag, roblox as ah, spotify as ai, tiktok as aj, twitch as ak, twitter as al, LANG as am, vk as an, zoom as ao, huggingface as ap, slack as aq, generateCodeChallenge as b, createAuthorizationURL as c, getOAuth2Tokens as d, encodeOAuthParameter as e, createAuthMiddleware as f, generateState as g, handleOAuthUserInfo as h, createAuthEndpoint as i, getSessionFromCtx as j, getSession as k, freshSessionMiddleware as l, optionsMiddleware as m, socialProviders as n, originCheck as o, parseState as p, sendVerificationEmailFn as q, refreshAccessToken as r, sessionMiddleware as s, createEmailVerificationToken as t, listSessions as u, validateAuthorizationCode as v, wildcardMatch as w, updateUser as x, originCheckMiddleware as y, error as z };
