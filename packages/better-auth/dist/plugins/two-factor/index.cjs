...
const backupCode2fa = (options) => {
  ...
  return {
    id: "backup_code",
    endpoints: {
      verifyBackupCode: socialProviders_index.createAuthEndpoint(
      ...
      generateBackupCodes: socialProviders_index.createAuthEndpoint(
      ...
      viewBackupCodes: socialProviders_index.createAuthEndpoint(
...
const otp2fa = (options) => {
  ...
  const send2FaOTP = socialProviders_index.createAuthEndpoint(
    "/two-factor/send-otp",
    {
      method: "POST",
      body: zod.z.object({
  ...
  const verifyOTP = socialProviders_index.createAuthEndpoint(
...
const totp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const generateTOTP = socialProviders_index.createAuthEndpoint(
    "/totp/generate",
    {
      method: "POST",
      body: zod.z.object({
  ...
  const getTOTPURI = socialProviders_index.createAuthEndpoint(
  ...
  const verifyTOTP = socialProviders_index.createAuthEndpoint(
...
const twoFactor = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...
      enableTwoFactor: socialProviders_index.createAuthEndpoint(
        "/two-factor/enable",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!isPasswordValid) {
            throw new betterCall.APIError("BAD_REQUEST", {
              message: socialProviders_index.BASE_ERROR_CODES.INVALID_PASSWORD
            });
          }
      ...
      disableTwoFactor: socialProviders_index.createAuthEndpoint(
        "/two-factor/disable",
        {
          method: "POST",
          body: zod.z.object({
