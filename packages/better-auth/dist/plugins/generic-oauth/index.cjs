...
const genericOAuth = (options) => {
  ...
  return {
    ...
    endpoints: {
      signInWithOAuth2: socialProviders_index.createAuthEndpoint(
        "/sign-in/oauth2",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2Callback: socialProviders_index.createAuthEndpoint(
      ...
      oAuth2LinkAccount: socialProviders_index.createAuthEndpoint(
        "/oauth2/link",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (c) => {
          ...
          if (!provider) {
            throw new betterCall.APIError("NOT_FOUND", {
              message: socialProviders_index.BASE_ERROR_CODES.PROVIDER_NOT_FOUND
            });
          }
          const {
            providerId,
