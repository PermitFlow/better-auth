...
const phoneNumber = (options) => {
  ...
  return {
    id: "phone-number",
    endpoints: {
      signInPhoneNumber: socialProviders_index.createAuthEndpoint(
      ...
      sendPhoneNumberOTP: socialProviders_index.createAuthEndpoint(
      ...
      verifyPhoneNumber: socialProviders_index.createAuthEndpoint(
        "/phone-number/verify",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!user) {
            throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
              message: socialProviders_index.BASE_ERROR_CODES.FAILED_TO_UPDATE_USER
            });
          }
       ...
       */
      forgetPasswordPhoneNumber: socialProviders_index.createAuthEndpoint(
      ...
      requestPasswordResetPhoneNumber: socialProviders_index.createAuthEndpoint(
      ...
      resetPasswordPhoneNumber: socialProviders_index.createAuthEndpoint(
