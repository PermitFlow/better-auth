...
const sso = (options) => {
  return {
    id: "sso",
    endpoints: {
      createOIDCProvider: socialProviders_index.createAuthEndpoint(
        "/sso/register",
        {
          method: "POST",
          body: zod.z.object({
      ...
      signInSSO: socialProviders_index.createAuthEndpoint(
        "/sign-in/sso",
        {
          method: "POST",
          body: zod.z.object({
      ...
      callbackSSO: socialProviders_index.createAuthEndpoint(
